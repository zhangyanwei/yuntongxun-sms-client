...
public abstract class AbstractRuntimeException extends RuntimeException implements IException {
    ...
    AbstractRuntimeException(Message message) {
        super(message.getMessage());
    }

    AbstractRuntimeException(Enum<?> code) {
        this.code = code;
        this.codeValue = errorCode(code);
    }

    AbstractRuntimeException(Enum<?> code, String message, Throwable cause) {
        super(message, cause);
        this.code = code;
        this.codeValue = errorCode(code);
    }

    AbstractRuntimeException(Enum<?> code, String message) {
        super(message);
        this.code = code;
        this.codeValue = errorCode(code);
    }

    AbstractRuntimeException(Enum<?> code, Throwable cause) {
        super(cause);
        this.code = code;
        this.codeValue = errorCode(code);
    }

    AbstractRuntimeException(String code) {
        this.codeValue = code;
    }

    AbstractRuntimeException(String code, String message) {
        super(message);
        this.codeValue = code;
    }

    AbstractRuntimeException(String code, String message, Object ... arguments) {
        super(message);
        this.codeValue = code;
